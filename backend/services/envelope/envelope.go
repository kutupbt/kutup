...
const (
	...
	KindExcalidrawOp     uint8 = 8 // v2 — whiteboard element delta (ephemeral; canonical state lives in snapshots)
	KindExcalidrawCursor uint8 = 9 // v2 — whiteboard pointer + selection presence (ephemeral)
)
