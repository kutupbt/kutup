...
All file content and metadata are encrypted client-side; the server stores only ciphertext.",
    ...
    paths(
        ...
        crate::handlers::chat_history_transfer::create,
        crate::handlers::chat_history_transfer::list,
        crate::handlers::chat_history_transfer::accept,
        crate::handlers::chat_history_transfer::put_frame,
        crate::handlers::chat_history_transfer::drain_frames,
        crate::handlers::chat_history_transfer::complete,
        crate::handlers::chat_history_transfer::cancel,
