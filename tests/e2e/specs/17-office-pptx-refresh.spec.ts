...
// Mirrors 11-office-docx-refresh for pptx. PR 47501b2's oo-self-on-ready
// fix is format-agnostic, but a pptx canary catches future drift and
// confirms the maybeStart() handshake works for all 3 office formats.
test.describe('office pptx — page refresh', () => {
