...
const styles: Record<string, React.CSSProperties> = {
  ...
  card: { background: '#1a1a1f', border: '1px solid #2a2a30', borderRadius: 12, padding: 40, width: '100%', maxWidth: 500 },
  ...
  link: { textAlign: 'center', marginTop: 16, fontSize: 13, color: '#8888aa' },
