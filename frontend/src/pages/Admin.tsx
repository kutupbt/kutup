...
const styles: Record<string, React.CSSProperties> = {
  ...
  stat: { background: '#1a1a1f', border: '1px solid #2a2a30', borderRadius: 10, padding: '16px 20px' },
  statNum: { fontSize: 24, fontWeight: 700, color: '#7c3aed' },
  statLabel: { fontSize: 12, color: '#8888aa', marginTop: 4 },
  settingsRow: { display: 'flex', alignItems: 'center', gap: 12, marginBottom: 16, padding: '12px 16px', background: '#1a1a1f', border: '1px solid #2a2a30', borderRadius: 8 },
  settingsLabel: { fontSize: 13, color: '#c8c8da', flex: 1 },
  ...
  badge: { marginLeft: 6, padding: '1px 6px', background: '#7c3aed40', color: '#a78bfa', borderRadius: 4, fontSize: 11 },
  smallBtn: { padding: '3px 8px', background: 'transparent', border: '1px solid #2a2a30', color: '#8888aa', borderRadius: 4, cursor: 'pointer', fontSize: 12, marginRight: 4 },
  ...
  spinner: { width: 32, height: 32, border: '3px solid #2a2a30', borderTop: '3px solid #7c3aed', borderRadius: '50%', margin: '80px auto', animation: 'spin 1s linear infinite' },
  ...
  modal: { background: '#1a1a1f', border: '1px solid #2a2a30', borderRadius: 12, padding: 32, width: '100%', maxWidth: 440 },
  modalTitle: { margin: '0 0 6px', fontSize: 18, fontWeight: 600, color: '#e8e8ea' },
  modalSubtitle: { margin: '0 0 20px', fontSize: 13, color: '#8888aa' },
  ...
  cancelBtn: { flex: 1, padding: '10px', background: 'transparent', border: '1px solid #2a2a30', color: '#8888aa', borderRadius: 8, fontSize: 14, cursor: 'pointer' },
  submitBtn: { flex: 1, padding: '10px', background: '#7c3aed', color: '#fff', border: 'none', borderRadius: 8, fontSize: 14, fontWeight: 600, cursor: 'pointer' },
}
