...
// OO_LOCK: peer-visible cell-edit lock state. Same envelope + AEAD as
// OO_OP but with a different kind so the relay routes it ephemerally
// (no file_update_log entry — locks are transient).
