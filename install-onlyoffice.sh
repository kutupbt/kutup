...
# kutup itself is MIT; OnlyOffice client JS is AGPL-3.0-or-later. Running
# this script downloads AGPL-licensed assets into frontend/public/onlyoffice/
# (gitignored). By running it you opt into AGPL distribution terms for that
# subdirectory.
#
